...
public class ClickStreamPageView extends Configured implements Tool {
	...
	/*	String inputPath="hdfs://node01:8020/weblog/"+DateUtil.getYestDate()+"/weblogPreOut";
		...
		job.setInputFormatClass(TextInputFormat.class);
		job.setOutputFormatClass(TextOutputFormat.class);
		TextInputFormat.addInputPath(job,new Path("file:///D:\\Study\\BigData\\heima\\stage2\\8、大数据离线第八天与第九天\\日志文件数据\\weblogPreOut2"));
		TextOutputFormat.setOutputPath(job,new Path("file:///D:\\Study\\BigData\\heima\\stage2\\8、大数据离线第八天与第九天\\日志文件数据\\pageViewOut2"));
